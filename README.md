...
> :warning: **`load_confounds` is now a new feature in NiLearn 0.8.2**. Development of this project will fully migrate to on [NiLearn](https://nilearn.github.io/stable/index.html). Please see the following links for the implementation.
> 
> New API:
