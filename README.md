...
> :warning: **`load_confounds` is now a new feature in NiLearn 0.8.2**. Development of this project will fully migrate to on [NiLearn](https://nilearn.github.io/stable/index.html). 
> 
> Please see [`nilearn.interfaces.fmriprep.load_confounds`](https://nilearn.github.io/dev/modules/generated/nilearn.interfaces.fmriprep.load_confounds.html#nilearn.interfaces.fmriprep.load_confounds) and [`nilearn.interfaces.fmriprep.load_confounds_strategy`](https://nilearn.github.io/dev/modules/generated/nilearn.interfaces.fmriprep.load_confounds_strategy.html#nilearn.interfaces.fmriprep.load_confounds_strategy)
